...
const PRODUCTS = [
    {
        ...
        category: ['Гонки', 'Симулятор', 'Открытый мир'],
        price: 2343,
    ...
    },
    {
        ...
        category: ['Глубокий сюжет', 'Протагонистка'],
    ...
    },
    {
        ...
        category: ['Паркур', 'РПГ', 'Открытый мир'],
